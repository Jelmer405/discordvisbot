...
xaxis: {
  ...
  if (command === 'price'){ //Attempt to get price of item
    ...
    message.channel.send("**Item not found.  Similar items: **"+itemList[nearLoc].name);
      ...
      playername=args[1];
      playername2=args[2];
      inputURL = 'http://secure.runescape.com/m=hiscore/compare?user1='+playername;
    request(inputURL, function(err, res, body) {
      text = body;
      ...
      ,"Herblore","Agility","Thieving","Slayer","Farming","Runecraft","Hunter","Construction","Summoning","Dungeoneering","Divination","Invention","Archaeology"];
